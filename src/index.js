exports.returnDay = (date, month, year) => {

   if( year % 100 == 0 ) {
      if( year % 400 == 0 && month == 2 && date > 29 ) return null;
      else if( year % 400 != 0 && month == 2 && date > 28 ) return null;
   } 
   else if( year % 100 != 0 ) {
      if( year % 4 == 0 && month == 2 && date > 29 ) return null;
      else if( year % 4 != 0 && month == 2 && date > 28 ) return null;
   }
